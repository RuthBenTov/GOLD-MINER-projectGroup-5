...
var goldMiner = document.querySelector(".header__character"); //-----------------------------Event Handlers-----------------------------
...
function handlePress(ev) {
  ...
  if (ev.key === "ArrowLeft") {
    if (Number(goldMiner.style.left.replace("px", "")) > -100) goldMiner.style.left = (Number(goldMiner.style.left.replace("px", "")) - 5).toString() + "px";
  }
...
var countDown = setInterval(function () {
  ...
  if (timeSecond <= 0) {
    ...
    alert("game over"); // window.location.href = "/project/view/gameOver.html";
  }
}, 1000);
