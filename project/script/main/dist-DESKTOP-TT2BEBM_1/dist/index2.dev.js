...
//     });
// }
var rope = document.querySelector(".header__rope"); // setInterval(() => {
//     const ropeRect = rope.getBoundingClientRect();
//     checkCollision(ropeRect);
// }, 10);
// // בדיקת התנגשות בין האבנים לבין ה-DIV המתארך
...
function checkCollision(ropeBottom, ropeLeft, ropeRect) {
  ...
  for (var i = 0; i < rocks.length; i++) {
    ...
    if (ropeRect.left < rocklocation.right && ropeRect.right > rocklocation.left && ropeRect.top < rocklocation.bottom && ropeRect.bottom > rocklocation.top) {
      getElementToPlayer(item);
      rope.style.width = "40px";
      rope.classList.remove("active"); // console.log(ropeTop, ropeLeft)
    }
  }
...
setInterval(function () {
  ...
  var ropeRect = rope.getBoundingClientRect(); // console.log(ropeBottom, ropeLeft, ropeRect)
